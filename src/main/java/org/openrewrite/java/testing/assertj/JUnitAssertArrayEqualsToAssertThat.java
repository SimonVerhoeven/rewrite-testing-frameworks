...
public class JUnitAssertArrayEqualsToAssertThat extends Recipe {
    ...
    public static class AssertArrayEqualsToAssertThatVisitor extends JavaIsoVisitor<ExecutionContext> {
        ...
        public J.MethodInvocation visitMethodInvocation(J.MethodInvocation method, ExecutionContext ctx) {
            ...
            if (args.size() == 2) {
                method = JavaTemplate.builder("assertThat(#{anyArray()}).containsExactly(#{anyArray()});")
                        .contextSensitive()
                ...
                method = JavaTemplate.builder("assertThat(#{anyArray()}).containsExactly(#{anyArray()}, within(#{any()}));")
                        .contextSensitive()
